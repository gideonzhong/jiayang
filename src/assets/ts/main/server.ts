...
mainServer.factory("mainServer", ["$http", "$q", "appconfig", function($http: angular.IHttpService, $q: angular.IQService, appconfig: any) {
    ...
    var appServerBaseUrl = appconfig.getAppBaseUrl();
   // var userToken = localStorage.getItem("userToken");
    var userselfToken = webimutil.CookieHelper.getCookie("loginselftoken");
//    console.log(userselfToken);
console.log("0"+serverBaseUrl);
console.log("1"+appServerBaseUrl);
    var mainServer = {
        user: {
            sendCode: function(phone: string, doType: string) {
                // console.log("111");
                return $http({
                    method: "GET",
                    // url: serverBaseUrl + "/user/send_code",
                    // url: appServerBaseUrl + "/web/user/getVerificationCode?phone=15951831136&doType=L",
                    url: appServerBaseUrl + "/app/user/getVerificationCode?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&phone="+phone+"&doType=R",
                    data: {
                        phone: phone,
                        doType: doType	
                    }
            ...
            verifyCode: function(phone: string, doType: string, code: string) {
                return $http({
                    method: "GET",
                    url: appServerBaseUrl + "/app/user/checkVerificationCode?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&phone="+phone+"&code="+code+"&doType="+doType,
                    data: {
                        phone: phone,
                        doType: doType,
                        code: code
            ...
            //     return $http({
            //         method: "GET",
            //         url: appServerBaseUrl + "/app/user/checkVerificationCode",
            //         data: {
            //             phone: phone,
            //             region: region
            //         }
            //     })
            // },
            checkPhoneAvailable: function(phone: string, code: string, doType: string) {
                console.log(phone);
                console.log(code);
                return $http({
                    method: "GET",
            ...
            signup: function(phone: string,code:string,password: string,invitationCode:string) {
                // console.log(phone);
                // console.log(code);
                ...
                return $http({
                    method: "GET",
                    url: appServerBaseUrl + "/web/user/userRegiste?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&phone="+phone+"&code="+code+"&password="+password+"&invitationCode="+invitationCode,
                    data: {
                        phone: phone,
                        code:code,                     
                        password: password,                    
            ...
            //  signup: function(phone: string,code:string,show:string,invitationCode:string,password: string,) {
            //     return $http({
            //         method: "GET",
            //         url: appServerBaseUrl + "/web/user/userRegiste",
            //         data: {
            //             phone: phone,
            //             code:code,
            //             show:show,
            ...
            //     })
            // },
            signin: function(phone: string, loginType: string, password: string) {
                return $http({
                    method: "POST",
                    url: appServerBaseUrl + "/web/user/userLogin",
                    data: {
                        phone: phone,
                        loginType: loginType,
                        password: password,
            ...
            //获取群成员详情
            getInfoS: function(userId: string) {
                return $http({
                    method: "get",
                    url:"http://www.baidu.com/app/user/tokenMethod/getCommunityUserInfo?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&userId="+userId,
                    // url: appServerBaseUrl + "/app/user/tokenMethod/getCommunityUserInfo?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&userId="+userId,
                   
                })
            },
            getInfo: function(ids: string) {
                return $http({
                    method: "get",
                    url: serverBaseUrl + "/user/" + ids
                })
            },
...
//              return $http({
//                  method: "get",
//                  url: serverBaseUrl + "/user/blacklist?t=" + new Date().getTime()
//              });
//          },
            ...
            getMyGroups: function() {
                return $http({
                    method: "get",
                    url: appServerBaseUrl + "/web/user/tokenMethod/getAllEnSpeakGroupByUserId?token="+webimutil.CookieHelper.getCookie("loginselftoken"),//获取加入社群列表
                });
            },
//          getMyGroups: function() {
//              return $http({
//                  method: "get",
//                  url: serverBaseUrl + "/user/groups?t=" + new Date().getTime()
//              });
//          },
        ...
        friend: {
            invite: function(friendId: string, message: string) {
                return $http({
                    method: "GET",
                    url: appServerBaseUrl + "/app/user/tokenMethod/addImRyNotice?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&imRyFriendUserId="+friendId+"&type=0",
                });
            },
//          invite: function(friendId: string, message: string) {
//              return $http({
...
//          },
            getAll: function() {
                return $http({
                    method: "get",
                    url: appServerBaseUrl + "/app/user/tokenMethod/getAllUserFriendUsers?token="+webimutil.CookieHelper.getCookie("loginselftoken"),//获取好友列表
                });
            },
            ...
            // alert(friendId);
                return $http({
                    ...
                    url: appServerBaseUrl + "/app/user/tokenMethod/userDeleteFriend?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&friendUserId="+friendId,
                    data: {
                        friendId: friendId
                    }
                })
            ...
            getProfile: function(id: string) {
                return $http({
                    method: "get",
                    url: appServerBaseUrl + "/app/user/tokenMethod/getUserFriendUser?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&friendUserId="+id,//好友详情
                  //  url: appServerBaseUrl + "/friendship/" + id + "/profile",GET /app/user/tokenMethod/getUserFriendUser
                });
            },
            setDisplayName: function(friendId: string, displayName: string,id: string) {
                return $http({
                    method: "get",
                    // url: serverBaseUrl + "/friendship/set_display_name",
                    url: appServerBaseUrl + "/app/user/tokenMethod/updateUserFriendUserNameRemark?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&friendUserId="+id,
                    data: {
                        friendId: friendId,
        ...
        group: {
            ...
            getGroupMember: function(id: string) {
                return $http({
                    method: "get",
                    url: appServerBaseUrl + "/app/community/tokenMethod/getCommunityUsers?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&communityId="+id,
                })
            },
            //获取群详情
            getGroupDetail: function(id: string) {
                return $http({
                    method: "get",
                    url: appServerBaseUrl + "/app/community/tokenMethod/getCommunityInfo?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&communityId="+id,
                })
            },
            upLoad: function(fileName: string,imGroupId:string,doType:string) {
                return $http({
                    method: "get",
...
//          },
            ...
            dismissGroup: function(groupId: string) {
                return $http({
                    method: "GET",
                    url: appServerBaseUrl + "/app/community/tokenMethod/delCommunity?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&communityId="+groupId,
                })
            },
            quit: function(groupId: string) {
                return $http({
                    method: "GET",
                    url: appServerBaseUrl + "/app/community/tokenMethod/outCommunity?token="+webimutil.CookieHelper.getCookie("loginselftoken")+"&communityId="+groupId,
//                  data: {
//                      groupId: groupId
//                  }
                })
                          ...
                          if (member) {
                              ...
                              (function(id: string, conv: webimmodel.Conversation) {
                                  mainServer.user.getInfo(id).success(function(user) {
                                      //conv.lastMsg = user.content.name + "：" + conversationitem.lastMsg;
...
//                            conv.title = rep.content.name + "(非好友)";
//                            conv.firstchar = webimutil.ChineseCharacter.getPortraitChar(rep.content.name);
//                            var obj = webimutil.ChineseCharacter.convertToABC(rep.content.name);
//                            var f = webimutil.ChineseCharacter.getPortraitChar(rep.content.name);
//                            conv.setpinying({ pinyin: obj.pinyin, everychar: obj.first, firstchar: f});
//                            conv.imgSrc = rep.content.avatar;
                              ...
                              mainDataServer.contactsList.addNonFriend(_friend);
                          	  ...
                          	  var _friend = new webimmodel.Friend({
                                  id: "1",
                                  name: "超火APP",
                                  imgSrc: "http://superfireoss-1255482466.file.myqcloud.com/GROUP_PICTURE/SFGP36765655171075.jpg"
                              });

                              mainDataServer.contactsList.addNonFriend(_friend);
                              conv.title = "超火APP";
                              conv.imgSrc = "http://superfireoss-1255482466.file.myqcloud.com/GROUP_PICTURE/SFGP36765655171075.jpg";
                          });
...
//                      	item.title = rep.content.name + "(非好友)";
//                          item.firstchar = webimutil.ChineseCharacter.getPortraitChar(rep.content.name);
//                          item.imgSrc = rep.content.avatar;
                ...
                case webimmodel.conversationType.Discussion:
                    ...
                    break;
                case webimmodel.conversationType.ChartRoom:
                	console.log("进入聊天室");
                    var groupinfo = mainDataServer.contactsList.getGroupById(targetId);
                    if (groupinfo) {
                        item.title = groupinfo.name;
...
mainServer.factory("RongIMSDKServer", ["$q", function($q: angular.IQService) {
    ...
    RongIMSDKServer.init = function(appkey: string) {
        ...
        //新图片自定义消息
        var imageViewMessagemessageName = "ImageViewMessage"; // 以前的图片消息类型，   后期会舍弃
		var imageViewMessageobjectName = "app:ImgMessage"; // 消息内置名称，请按照此格式命名。
		var imageViewMessagemesasgeTag = new RongIMLib.MessageTag(true,true);// 消息是否保存是否计数，true true 保存且计数，false false 不保存不计数。
		var imageViewMessagepropertys = ["imageViewUrl","user"]; // 消息类中的属性名。
		RongIMLib.RongIMClient.registerMessageType(imageViewMessagemessageName,imageViewMessageobjectName,imageViewMessagemesasgeTag,imageViewMessagepropertys);
        
        
        var imgMessageeName = "ImgMessage"; // 最近发送图片消息类型
		var imgMessaGeobjectName = "app:ImgMedialMsg"; // 消息内置名称，请按照此格式命名。
		var imgMessageTag = new RongIMLib.MessageTag(true,true);// 消息是否保存是否计数，true true 保存且计数，false false 不保存不计数。
		var imgMessagePropertys = ["mMediaUrl","user"]; // 消息类中的属性名。
		RongIMLib.RongIMClient.registerMessageType(imgMessageeName,imgMessaGeobjectName,imgMessageTag,imgMessagePropertys);

		//视频消息
        var videoMessageName = "VideoMessage"; // 第一次定义的视频消息类型
		var videoMessageobjectName = "app:VideoMessage"; // 消息内置名称，请按照此格式命名。
		var videoMessagemesasgeTag = new RongIMLib.MessageTag(true,true);// 消息是否保存是否计数，true true 保存且计数，false false 不保存不计数。
		var videoMessagepropertys = ["videoUrl","videoPicture"]; // 消息类中的属性名。
        RongIMLib.RongIMClient.registerMessageType(videoMessageName,videoMessageobjectName,videoMessagemesasgeTag,videoMessagepropertys);
        
        var VideoMsgName = "VideoMsg"; // 第二次定义的视频消息类型       和第一次定义的视频消息类型，并存
		var VideoMsgObjectName = "app:VideoMsg"; // 消息内置名称，请按照此格式命名。
		var VideoMsgTag = new RongIMLib.MessageTag(true,true);// 消息是否保存是否计数，true true 保存且计数，false false 不保存不计数。
		var VideoMsgPropertys = ["mMediaUrl","mExtra"]; // 消息类中的属性名。
		RongIMLib.RongIMClient.registerMessageType(VideoMsgName,VideoMsgObjectName,VideoMsgTag,VideoMsgPropertys);
    ...
    RongIMSDKServer.sendMessage = function(conver: number, targetId: string, content: any, isAt: boolean) {
		...
		console.log("9999999"+conver + ',' +targetId+','+content);
...
interface mainServer {
    user: {
        ...
        signup(phone: string,code:string,password: string,invitationCode:string): angular.IHttpPromise<any>
        signin(phone: string, loginType: string, password: string): angular.IHttpPromise<any>
        logout(): angular.IHttpPromise<any>
        getInfo(ids: string): angular.IHttpPromise<{ result: { id: string, nickname: string, portraitUri: string, displayName: string }, code: number }>
        getInfoS(userId: string): angular.IHttpPromise<{ content: {userInfo:{userFriendUserId: string, name: string, avatar: string }}, code: number }>
 ...
 //       getBlackList(): angular.IHttpPromise<any>
    ...
    group: {
        ...
        getGroupDetail(id: string): angular.IHttpPromise<any>
        upLoad(fileName: string,imGroupId:string,doType:string): angular.IHttpPromise<any>
